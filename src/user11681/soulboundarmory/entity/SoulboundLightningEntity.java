...
public class SoulboundLightningEntity extends LightningEntity implements LightningEntityAccess, CompoundSerializable {
    ...
    public void tick() {
        ...
        this.ambientTick(this.ambientTick() - 1);
        ...
        if (this.ambientTick() >= 0) {
            if (this.world.isClient) {
                ...
                for (Entity entity : this.world.getOtherEntities(this,
                    ...
                    if (entity != caster && entity instanceof LivingEntity) {
                        ...
                        if (caster instanceof PlayerEntity) {
                            ...
                            float attackDamageModifier = EnchantmentHelper.getAttackDamage(itemStack, target.getGroup());
                            int burnTime = 0;

                            if (attackDamage > 0 || attackDamageModifier > 0) {
                                int knockbackModifier = EnchantmentHelper.getKnockback(caster);
