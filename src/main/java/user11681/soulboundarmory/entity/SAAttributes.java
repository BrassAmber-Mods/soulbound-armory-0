...
public final class SAAttributes {
    ...
    public static final Attribute criticalStrikeProbability = generic("critical_strike_probability", 1, 1).setSyncable(true);
    ...
    private static RangedAttribute generic(String name, double fallback, double max) {
        RangedAttribute attribute = new RangedAttribute("generic.%s.%s".formatted(SoulboundArmory.ID, name), fallback, 0, max);
