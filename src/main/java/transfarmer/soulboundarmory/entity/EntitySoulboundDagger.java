...
public class EntitySoulboundDagger extends EntityArrowExtended {
    ...
    private IWeaponCapability capability;

    public EntitySoulboundDagger(final World world) {
        super(world);
    }

    public EntitySoulboundDagger(final World world, final double x, final double y, final double z) {
        super(world, x, y, z);
    }

    public EntitySoulboundDagger(final World world, final EntityLivingBase shooter, final ItemStack itemStack,
    ...
    public EntitySoulboundDagger(final EntitySoulboundDagger original, final boolean spawnClone) {
    ...
    protected void onHit(final RayTraceResult result) {
        ...
        if (entity != null) {
            if (this.spawnClone) {
                this.world.spawnEntity(new EntitySoulboundDagger(this, false));
            }
            ...
            if (this.shootingEntity instanceof EntityPlayer) {
                ...
                if (attackDamage > 0) {
                    ...
                    if (entity.attackEntityFrom(damageSource, (float) attackDamage)) {
                        ...
                        this.applyEnchantments(player, entity);
