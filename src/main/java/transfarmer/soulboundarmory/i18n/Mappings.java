...
public class Mappings {
    ...
    public static final String SOUL_DAGGER_NAME = I18n.format("item.soulboundarmory.soulboundDagger");
    public static final String SOUL_STAFF_NAME = I18n.format("item.soulboundarmory.soulboundStaff");
    ...
    public static final String MENU_KEY_NAME = I18n.format("key.soulboundarmory.menu");
    ...
    public static final String SHARPNESS_NAME = I18n.format("enchantment.soulboundarmory.sharpness");
    public static final String SWEEPING_EDGE_NAME = I18n.format("enchantment.soulboundarmory.sweepingEdge");
    public static final String LOOTING_NAME = I18n.format("enchantment.soulboundarmory.looting");
    public static final String FIRE_ASPECT_NAME = I18n.format("enchantment.soulboundarmory.fireAspect");
    public static final String KNOCKBACK_ENCHANTMENT_NAME = I18n.format("enchantment.soulboundarmory.knockback");
    public static final String SMITE_NAME = I18n.format("enchantment.soulboundarmory.smite");
    public static final String BANE_OF_ARTHROPODS_NAME = I18n.format("enchantment.soulboundarmory.baneOfArthropods");
    public static final String EFFICIENCY_ENCHANTMENT_NAME = I18n.format("enchantment.soulboundarmory.efficiency");
    public static final String FORTUNE_NAME = I18n.format("enchantment.soulboundarmory.fortune");
    public static final String SILK_TOUCH_NAME = I18n.format("enchantment.soulboundarmory.silkTouch");
