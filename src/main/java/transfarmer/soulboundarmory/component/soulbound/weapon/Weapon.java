...
public class Weapon extends SoulboundBase implements IWeaponCapability {
    private CompoundTag cannotFreeze;
    ...
    public Map<String, EntityAttributeModifier> getEntityAttributeModifiers(final IItem type) {
        return CollectionUtil.hashMap(super.getEntityAttributeModifiers(type),
                new String[]{
                        SharedMonsterAttributes.ATTACK_SPEED.getName(),
                        SharedMonsterAttributes.ATTACK_DAMAGE.getName(),
                },
                new EntityAttributeModifier(ItemSoulbound.ATTACK_SPEED_MODIFIER, "generic.attackSpeed", this.getAttributeRelative(type, ATTACK_SPEED), ADD),
                new EntityAttributeModifier(ItemSoulbound.ATTACK_DAMAGE_MODIFIER, "generic.attackDamage", this.getAttributeRelative(type, ATTACK_DAMAGE), ADD)
        );
    }
    ...
    public List<ScreenTab> getTabs() {
        ...
        tabs = CollectionUtil.arrayList(new WeaponSelectionTab(tabs), new WeaponAttributesTab(tabs), new EnchantmentsTab(WEAPONS, tabs), new SkillsTab(WEAPONS, tabs));
    ...
    public CompoundTag toCompoundTag() {
        final CompoundTag tag = super.toTag();
    ...
    public CompoundTag toCompoundTagClient() {
        final CompoundTag tag = super.toCompoundTagClient();
