...
public class S2CEnchantmentPoints implements IExtendedMessage {
    private String capability;
    private String item;
    private ResourceLocation enchantment;
    private int amount;

    public S2CEnchantmentPoints() {}

    public S2CEnchantmentPoints(final ICapabilityType capability,
    ...
    public static final class Handler implements IExtendedMessageHandler<S2CEnchantmentPoints> {
        @SideOnly(CLIENT)
        @Override
        public IExtendedMessage onMessage(final S2CEnchantmentPoints message, final MessageContext context) {
            ...
            final ICapabilityEnchantable capability = (ICapabilityEnchantable) minecraft.player.getCapability(ICapabilityType.get(message.capability).getCapability(), null);
