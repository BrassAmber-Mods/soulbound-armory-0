...
import static transfarmer.soularsenal.data.weapon.SoulWeaponDatum.*;
import static transfarmer.soularsenal.data.weapon.SoulWeaponEnchantment.*;
...
public class SoulWeaponMenu extends GuiScreen {
    ...
    private void drawAttributes(final Renderer renderer, final int mouseX, final int mouseY) {
        ...
        final String attackDamage = String.format("%s%s: %%s", Mappings.ATTACK_DAMAGE_FORMAT, Mappings.ATTACK_SPEED_NAME);
