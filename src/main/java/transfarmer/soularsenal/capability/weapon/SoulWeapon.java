...
import static transfarmer.soularsenal.capability.weapon.SoulWeaponHelper.ATTACK_DAMAGE_UUID;
import static transfarmer.soularsenal.capability.weapon.SoulWeaponHelper.ATTACK_SPEED_UUID;
import static transfarmer.soularsenal.capability.weapon.SoulWeaponHelper.ATTRIBUTES;
import static transfarmer.soularsenal.capability.weapon.SoulWeaponHelper.DATA;
import static transfarmer.soularsenal.capability.weapon.SoulWeaponHelper.ENCHANTMENTS;
import static transfarmer.soularsenal.capability.weapon.SoulWeaponHelper.REACH_DISTANCE_UUID;
import static transfarmer.soularsenal.data.weapon.SoulWeaponAttribute.ATTACK_DAMAGE;
import static transfarmer.soularsenal.data.weapon.SoulWeaponAttribute.ATTACK_SPEED;
import static transfarmer.soularsenal.data.weapon.SoulWeaponAttribute.CRITICAL;
import static transfarmer.soularsenal.data.weapon.SoulWeaponAttribute.EFFICIENCY;
import static transfarmer.soularsenal.data.weapon.SoulWeaponAttribute.KNOCKBACK_ATTRIBUTE;
...
import static transfarmer.soularsenal.data.weapon.SoulWeaponEnchantment.SHARPNESS;
