...
public class StatisticType extends RegistryEntry<StatisticType> {
    ...
    public static final StatisticType criticalHitRate = new StatisticType("critical_hit_rate");
    ...
    public static final StatisticType upgradeProgress = new StatisticType("upgrade_progress");
