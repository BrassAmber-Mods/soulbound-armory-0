...
public interface TextFormatter {
     ...
     */
    void format(CharacterRendererAccess drawer, Style style, int charIndex, int character, FontStorage font, Glyph glyph, GlyphRenderer glyphRenderer, TextColor color, float red, float green, float blue, float advance);
}
